...
public class SpotActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mapTxt.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				intent = new Intent(SpotActivity.this,
						OverlayDemo.class);
		...
		if (spot != null) {
			if(StringUtil.isEmpty(spot.getQq())){
				spot.setQq("http://www.college360.cn/source/plugin/dz55625_haodian/upimg/20160308/20160308211337284.jpg&http://www.weibo.com/college360/home?wvr=5");
			}
			// 景点名
			...
			imageLogo.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					StringUtil.saveInfo(SpotActivity.this, "PanoramaGL",
							spot.getSpotPanorama());
					startActivity(intent);
				}
			});
		} else {
	...
	class CommentAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup arg2) {
			if (convertView == null || position < commentList.size()) {
				...
				// 加载组件
				viewHolder.imageUser = (CircleImageView) convertView
						.findViewById(R.id.imageUser);
				viewHolder.textContent = (TextView) convertView
						.findViewById(R.id.textContent);
				viewHolder.textUpdateTime = (TextView) convertView
						.findViewById(R.id.textUpdateTime);
				viewHolder.textUserName = (TextView) convertView
						.findViewById(R.id.textUserName);
				viewHolder.textZan = (TextView) convertView
						.findViewById(R.id.textZan);
			...
			if (comment.getUserName() == null
					|| comment.getUserName().equals("null")) {
	...
	private void saveData(String imageUrl) {
		...
		FileUtil.setStringToFile("/stone", SpotActivity.this, "test.data",
				result);
	}
	...
	private void submitComm(String suContent) {
		if(!StringUtil.isEmpty(suContent)){
			if (commTask != null
					&& commTask.getStatus() == AsyncTask.Status.RUNNING) {
	...
	public class GetPTask extends AsyncTask<Integer, String, Integer> {
		...
		protected Integer doInBackground(Integer... params) {
			...
			gson = new Gson();
			String result = HttpUtil.doPostForm(map, Constants.GETCOMLISTBYSP
					+ "&spotid=" + spot.getSpotId(), false, SpotActivity.this);
		...
		protected void onPostExecute(Integer result) {
			...
			if (result == Constants.SUCCESS) {
				commentAdapter = new CommentAdapter(SpotActivity.this,
						commentList);
				listViewComment.setAdapter(commentAdapter);
			} else {
	...
	public class CommTask extends AsyncTask<Integer, String, Integer> {
		...
		protected Integer doInBackground(Integer... params) {
			...
			String result = HttpUtil.doPostForm(map, Constants.ADDCOMMENT
					+ "&userid=220&spotid=" + spot.getSpotId() + "&comment="+str,
					false, SpotActivity.this);
			if (StringUtil.isEmpty(result)) {
				msgs = "连接服务器超时，请确认网络畅通";
				return Constants.FAILURE;
			}
